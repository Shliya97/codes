...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 26 00:43:36 2024
...
sns.set(style="whitegrid")
# Load the dataset
data = pd.read_csv('top_cpg_sites_lasso_LT.csv', index_col=0)
...
normalized_data.to_csv('Processed-DNA-data_lasso_LT.csv', index=False)
...
data = pd.read_csv('Processed-DNA-data_lasso_LT.csv')
